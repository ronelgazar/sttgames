...
class Recognizer{
    ...
    equals(string){
        ...
        for(let a of this.dict[string]){
            if(this.transcript.toLowerCase().split(" ").includes(a.toLowerCase())) return this.clear(true);
        }
...
window.onload = function() {
    ...
    var indexes = Object.keys(dict);

    // var dict = ["red", "green", "blue", "yellow", "pink", "white"];
    ...
    function update(tframe) {
        ...
        if (gamestate == gamestates.ready && speech.equals(indexes[player.bubble.tiletype])) {
            shootBubble();
    ...
    function onMouseDown(e) {
        ...
        // if (gamestate == gamestates.ready && speech.transcript.toLowerCase() === dict[player.bubble.tiletype]) {
        //     shootBubble();
        // } else 
        if (gamestate == gamestates.gameover) {
            newGame();
