...
export class GameStage{
    ...
    constructor(game){
        ...
        this.game.speech.stop();
        this.game.speech.start();
    ...
    update(dt){
        ...
        if(!this.won && this.game.speech.equals(this.game.indexes[this.currentColor.color - 1])){
            this.game.speech.clear();
            this.game.speech.listen = false;
            this.currentColor.dead = true;
    ...
    render(ctx){
        ...
        ctx.font = "80px Arial Rounded MT";
        ctx.fillStyle = "#eabd8"
        let title = "Say the color";
        ctx.fillText(title, 70, 400);
        ctx.fillText("That moves",70, 500);
